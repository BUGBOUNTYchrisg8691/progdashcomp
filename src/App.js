...
function App() {
  ...
  return (
    ...
    >
      ...
      {/*  <Col gutter={8}>*/}
      {/*    {fakeData.slice(0, Math.floor(fakeData.length / 2)).map((prog) => (*/}
      {/*      <Card*/}
      {/*        hoverable*/}
      {/*        key={prog.programid}*/}
      {/*        style={{ margin: '20px' }}*/}
      ...
      {/*        <h5>{prog.program_description}</h5>*/}
      {/*      </Card>*/}
      {/*    ))}*/}
      {/*  </Col>*/}
      {/*</Row>*/}
      {/*<Row gutter={16} style={{ margin: '20px' }}>*/}
      {/*  <Col gutter={8}>*/}
      {/*    {fakeData.slice(Math.floor(fakeData.length / 2), fakeData.length).map((prog) => (*/}
      {/*      <Card*/}
      {/*        hoverable*/}
      {/*        key={prog.programid}*/}
      {/*        style={{ margin: '20px' }}*/}
